...
// enabling i2c_slave_mode calls i2c_conclr(obj,1,1,1,0) then i2c_conset(obj,0,0,0,1)
// otherwise it calls i2c_conclr(obj,1,1,1,1)
// check out https://interrupt.memfault.com/blog/i2c-in-a-nutshell#ones-and-zeroes 

// Retrieved from http://libopencm3.org/docs/latest/lpc43xx/html/i2c_8h_source.html#l00082 
...
// Retrieved from https://www.bogotobogo.com/cplusplus/quiz_bit_manipulation.php 
...
// Called to initialize both I2CSlave and I2C (master) objects, so probably want to use this for EVE as well 
...
// Only I2C objects use this function, I2CSlave never calls it 
...
// Called by both I2CSlave and I2C as part of their read functions 
